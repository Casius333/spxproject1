...
export default function AuthModal({ isOpen, onClose, defaultMode = 'login' }: AuthModalProps) {
  ...
  function onSubmit(values: z.infer<typeof loginSchema>) {
    if (activeTab === 'login') {
      ...
      const { confirmPassword, ...registerData } = values as z.infer<typeof registerSchema>;
  ...
  return (
    <div className="fixed inset-0 bg-black/80 z-[9999] overflow-y-auto">
      <div className="flex min-h-full items-center justify-center p-4 text-center">
        <div className="relative bg-dark-card w-full max-w-md rounded-xl overflow-hidden z-[10000] p-6 shadow-2xl">
          {/* Close button */}
          <button 
            onClick={onClose}
          ...
          <Tabs 
            ...
            className="w-full"
          >
            <div className="px-0 pt-2 pb-4 bg-gradient-to-r from-primary/20 to-transparent rounded-md">
            ...
            {/* Login Tab */}
            <TabsContent value="login" className="px-0 pb-6 pt-4">
            ...
            {/* Register Tab */}
            <TabsContent value="register" className="px-0 pb-6 pt-4">
              <div className="min-h-[300px]">
