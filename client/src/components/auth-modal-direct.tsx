...
export default function AuthModalDirect({ isOpen, onClose, defaultTab = 'login' }: AuthModalProps) {
  ...
  console.log("Auth modal direct rendering with isOpen:", isOpen);
  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center">
      ...
      {/* Modal content */}
      <div className="max-w-md p-0 overflow-hidden bg-dark-card relative z-[1000] w-full rounded-lg">
        {/* Decorative elements */}
        ...
        <Tabs 
          ...
          className="w-full"
        >
          <div className="px-6 pt-0 pb-4 bg-gradient-to-r from-primary/20 to-transparent">
